...
import { COMPETITION_REGEX, FF_MATCH_BASE_URL, FF_TEAM_URL, PREFIX_REGEX, SKY_TEAM_URL, STADIUM_REGEX, TIMEZONE } from './data'
import { FootballCompetition, ForzaFootballMatch } from './types'
import { fetchMsgPack, isSameDate, toBase32Hex } from '@/utils'

export const parseEvents = async (events): Promise<calendar_v3.Schema$Event[]> => {
